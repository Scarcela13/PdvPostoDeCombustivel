...
public class ContatoForm extends JFrame {
    ...
    private static final Color BACKGROUND_COLOR = new Color(250, 250, 250); // Cinza claro
    private static final Color BUTTON_HOVER_COLOR = new Color(180, 15, 50); // Vermelho mais escuro para hover
